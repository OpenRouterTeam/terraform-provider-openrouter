...
func newBenchmarks(rootSDK *OpenRouter, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Benchmarks {
	return &Benchmarks{
		rootSDK:          rootSDK,
...
func (s *Benchmarks) List(ctx context.Context, request operations.GetBenchmarksRequest, opts ...operations.Option) (*operations.GetBenchmarksResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/benchmarks")
	if err != nil {
	...
	res := &operations.GetBenchmarksResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.UnifiedBenchmarksResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UnifiedBenchmarksResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
