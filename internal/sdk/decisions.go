...
func newDecisions(rootSDK *OpenRouter, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Decisions {
	return &Decisions{
		rootSDK:          rootSDK,
...
func (s *Decisions) Decisions(ctx context.Context, request shared.DecisionsRequest, opts ...operations.Option) (*operations.CreateAPIAlphaDecisionsResponse, error) {
	...
	res := &operations.CreateAPIAlphaDecisionsResponse{
