...
// SystemOne - System One endpoints for models such as Jev, compatible with the TypeSafe SDKs. See https://openrouter.ai/docs/guides/community/typesafe-sdk.
...
func newSystemOne(rootSDK *OpenRouter, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *SystemOne {
	return &SystemOne{
		rootSDK:          rootSDK,
...
func (s *SystemOne) Create(ctx context.Context, request shared.DecisionsRequest, opts ...operations.Option) (*operations.CreateSystemoneResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/systemone")
	if err != nil {
	...
	res := &operations.CreateSystemoneResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.DecisionsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.DecisionsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
