...
func newVideos(rootSDK *OpenRouter, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Videos {
	return &Videos{
		rootSDK:          rootSDK,
...
// GetGenerationStatus - Poll video generation status
// Returns job status and content URLs when completed
func (s *Videos) GetGenerationStatus(ctx context.Context, request operations.GetVideosRequest, opts ...operations.Option) (*operations.GetVideosResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/videos/{jobId}", request, nil)
	if err != nil {
...
// ListModels - List all video generation models
// Returns a list of all available video generation models and their properties
func (s *Videos) ListModels(ctx context.Context, opts ...operations.Option) (*operations.ListVideosModelsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.VideoModelsListResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
