...
func (u UpdateWorkspaceResponseData) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(u, "", false)
}

func (u *UpdateWorkspaceResponseData) UnmarshalJSON(data []byte) error {
...
func (u *UpdateWorkspaceResponseData) GetDisabledServerTools() []string {
	if u == nil {
		return nil
	}
