...
func (u *UpdateGuardrailResponseData) GetAllowedDataRegions() []GuardrailDataRegion {
	if u == nil {
		return nil
	}
	return u.AllowedDataRegions
}
...
func (u *UpdateGuardrailResponseData) GetEnableFreeModelPublication() *bool {
	if u == nil {
		return nil
	}
...
func (u *UpdateGuardrailResponseData) GetEnableFreeModelTraining() *bool {
	if u == nil {
		return nil
	}
...
func (u *UpdateGuardrailResponseData) GetEnablePaidModelTraining() *bool {
	if u == nil {
		return nil
	}
...
func (u *UpdateGuardrailResponseData) GetIncludeByokInBudgets() bool {
	if u == nil {
		return false
	}
