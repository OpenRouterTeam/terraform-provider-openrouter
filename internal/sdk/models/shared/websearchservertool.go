...
func (w *WebSearchServerTool) GetFilters() *WebSearchDomainFilter {
	if w == nil {
		return nil
	}
	return w.Filters
...
func (w *WebSearchServerTool) GetMaxUses() *int64 {
	if w == nil {
		return nil
	}
	return w.MaxUses
...
func (w *WebSearchServerTool) GetMode() *WebSearchMode {
	if w == nil {
		return nil
	}
	return w.Mode
...
func (w *WebSearchServerTool) GetUserLocation() *WebSearchUserLocation {
	if w == nil {
		return nil
	}
...
func (w *WebSearchServerTool) GetXSearch() *XSearchOptions {
	if w == nil {
		return nil
	}
	return w.XSearch
