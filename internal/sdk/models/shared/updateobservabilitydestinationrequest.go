...
func (u *UpdateObservabilityDestinationRequest) GetAPIKeyHashes() []string {
	if u == nil {
		return nil
	}
...
func (u *UpdateObservabilityDestinationRequest) GetFilterRules() *ObservabilityFilterRulesConfigNullable {
	if u == nil {
		return nil
	}
