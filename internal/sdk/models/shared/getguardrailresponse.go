...
func (g *GetGuardrailResponseData) GetAllowedDataRegions() []GuardrailDataRegion {
	if g == nil {
		return nil
	}
...
func (g *GetGuardrailResponseData) GetEnableFreeModelPublication() *bool {
	if g == nil {
		return nil
	}
...
func (g *GetGuardrailResponseData) GetEnableFreeModelTraining() *bool {
	if g == nil {
		return nil
	}
...
func (g *GetGuardrailResponseData) GetEnablePaidModelTraining() *bool {
	if g == nil {
		return nil
	}
...
func (g *GetGuardrailResponseData) GetIncludeByokInBudgets() bool {
	if g == nil {
		return false
	}
