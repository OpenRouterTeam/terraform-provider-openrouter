...
func (p *ProviderOptions) GetAmazonBedrockClaudeOnAws() map[string]any {
	if p == nil {
		return nil
	}
	return p.AmazonBedrockClaudeOnAws
}
...
func (p *ProviderOptions) GetCosine() map[string]any {
	if p == nil {
		return nil
	}
	return p.Cosine
...
func (p *ProviderOptions) GetDarkbloom() map[string]any {
	if p == nil {
		return nil
	}
	return p.Darkbloom
...
func (p *ProviderOptions) GetDigitalocean() map[string]any {
	if p == nil {
		return nil
	}
...
func (p *ProviderOptions) GetHeygen() map[string]any {
	if p == nil {
		return nil
	}
	return p.Heygen
...
func (p *ProviderOptions) GetInferactVllm() map[string]any {
	if p == nil {
		return nil
	}
	return p.InferactVllm
}
