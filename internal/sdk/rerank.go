...
func (s *Rerank) Submit(ctx context.Context, request operations.CreateRerankRequest, opts ...operations.Option) (*operations.CreateRerankResponse, error) {
