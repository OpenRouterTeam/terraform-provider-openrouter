...
func (s *Workspaces) ListBudgets(ctx context.Context, request operations.ListWorkspaceBudgetsRequest, opts ...operations.Option) (*operations.ListWorkspaceBudgetsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/workspaces/{workspace_ref}/budgets", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *Workspaces) DeleteBudget(ctx context.Context, request operations.DeleteWorkspaceBudgetRequest, opts ...operations.Option) (*operations.DeleteWorkspaceBudgetResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/workspaces/{workspace_ref}/budgets/{interval}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
