...
func (s *Tts) CreateSpeech(ctx context.Context, request shared.SpeechRequest, opts ...operations.Option) (*operations.CreateAudioSpeechResponse, error) {
	...
	if o.AcceptHeaderOverride != nil {
		...
		req.Header.Set("Accept", "application/json;q=1, audio/*;q=0")
	}
