...
// Generated from OpenAPI doc version 1.0.0 and generator version 2.930.0
...
func New(opts ...SDKOption) *OpenRouter {
	sdk := &OpenRouter{
		SDKVersion: "0.2.29",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.2.29 2.930.0 1.0.0 github.com/OpenRouterTeam/terraform-provider-openrouter/internal/sdk",
